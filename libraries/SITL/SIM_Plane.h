...
protected:
    const float hover_throttle = 5.25f;
    ...
    struct {
        ...
        float b = 2.04;//1.88;
        float c = 0.4;//0.24;
        float c_lift_0 = 0.202;//0.56;
        float c_lift_deltae = 0.174;//0;
        float c_lift_a = 3.708;//6.9;
        float c_lift_q = 0;
        float mcoeff = 50;
        float oswald = 0.9;
        float alpha_stall = 0.269f;//0.4712;
        float c_drag_q = 0;
        float c_drag_deltae = 0.012f;//0.0;
        float c_drag_p = 0.034f;//0.1;
        float c_y_0 = 0;
        float c_y_b = -0.131f;//-0.98;
        float c_y_p = 0;
        float c_y_r = 0;
        float c_y_deltaa = 0;
        float c_y_deltar = -0.2;
        float c_l_0 = 0;
        float c_l_p = -1.615f;//-1.0;
        float c_l_b = -0.12;//-0.12;
        float c_l_r = 0.1;//0.14;
        float c_l_deltaa = 0.095f;//0.25;
        float c_l_deltar = 0.0f;//-0.037;
        float c_m_0 = -0.02;// 0.045;
        float c_m_a = -0.572f;//-0.7;
        float c_m_q = -10.0f;//-20;
        float c_m_deltae = 0.3f;//1.0;
        float c_n_0 = 0;
        float c_n_b = 0.041f;//0.25;
        float c_n_p = 6.524e-3;//0.022;
        float c_n_r = -0.067f;//-1;
        float c_n_deltaa = 0.00;
        float c_n_deltar = 0.019f;//0.1;
        float deltaa_max = 0.35f;//0.3491;
        float deltae_max = 0.436;//0.3491;
        float deltar_max = 0.524f;//0.3491;
    ...
    float get_thrust(float throttle) const;
    float get_rpm(float throttle) const;
    float get_current(float throttle) const;
    float get_thrust_prop(float RPM, float airspeed) const;
    float linear_from_rpm(Plane::Prop prop[30], float airspeed_rpm) const;
